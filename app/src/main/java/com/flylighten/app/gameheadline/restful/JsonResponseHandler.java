 ...
 */
public class JsonResponseHandler extends TextHttpResponseHandler {
     ...
     */
    public JsonResponseHandler(boolean useRFC5179CompatibilityMode) {
        super(DEFAULT_CHARSET);
     ...
     * @param useRFC5179CompatibilityMode Boolean mode to use RFC5179 or latest
     */
    public JsonResponseHandler(String encoding, boolean useRFC5179CompatibilityMode) {
        super(encoding);
        this.useRFC5179CompatibilityMode = useRFC5179CompatibilityMode;
    }
